...
def add_to_excel():
    ...
    ##-----------把前端表單的東東存在變數裡--------------
    food_class_JSON = request.get_json()  ##得到{name: name, price: price, unit: unit, food_class: food_class}

    food_class = food_class_JSON['food_class']  ##取出"data"的值 {key : value}
    name = food_class_JSON['name']  ##取出"data"的值 {key : value}
    price = food_class_JSON['price']  ##取出"data"的值 {key : value}
    unit = food_class_JSON['unit']  ##取出"data"的值 {key : value}
    print(food_class_JSON)
    ##-----------把前端表單的東東存在變數裡--------------
